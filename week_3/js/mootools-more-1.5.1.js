...
web build:
 - http://mootools.net/more/ae399783bb76e966146e8c4ccfa14eb1

packager build:
 - packager build More/Fx.Reveal More/Fx.Scroll
...
MooTools.More={version:"1.5.1",build:"2dd695ba957196ae4b0275a690765d6636a61ccd"};Element.implement({isDisplayed:function(){return this.getStyle("display")!="none";
...
OverText.each(function(e){c.include("."+e.options.labelClass);});if(c){b+=c.join(", ");}}return(b)?d.element.getElements(b):null;};Fx.Reveal=new Class({Extends:Fx.Morph,options:{link:"cancel",styles:["padding","border","margin"],transitionOpacity:"opacity" in document.documentElement,mode:"vertical",display:function(){return this.element.get("tag")!="tr"?"block":"table-row";
